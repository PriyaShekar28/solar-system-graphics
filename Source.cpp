...
void display(void)
{
	...
	glutSolidSphere(0.2, 20, 8); /*draw planet mercury*/
	glPopMatrix();
	glPushMatrix();
	...
	glutSolidSphere(0.2, 20, 8); /*draw plant venus*/
	glPopMatrix();
	glPushMatrix();
	...
	glutSolidSphere(0.2, 20, 8); /*draw plant earth*/
	...
	glutSolidSphere(0.2, 20, 8); /*draw planet mars*/
	glPopMatrix();
	glPushMatrix();
	...
	glutSolidSphere(0.2, 20, 8);/*draw planet Jupiter*/
	glPopMatrix();
	glPushMatrix();
	...
	glutSolidSphere(0.5, 20, 16); /*draw plant Saturn*/
	int i = 0;
...
void welcomeDisplay() {
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
	glColor3f(1, 1, 1);
	glRasterPos3f(-1.8, 2, 1);
	char msg1[] = "SJB INSTITUTE OF TECHNOLOGY";
	for(int i=0;i<strlen(msg1);i++)
	glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, msg1[i]);

	glRasterPos3f(-1.1,1.5, 0);
	char msg2[] = "SOLAR SYSTEM";
	...
	char msg4[] = "Navya H (1JB19S088)";
	for (int i = 0;i < strlen(msg4);i++)
		glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg4[i]);

	glRasterPos3f(0.5, 0.1, 0);
	char msg5[] = "Priya S (1JB19S104)";
	for (int i = 0;i < strlen(msg5);i++)
		glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg5[i]);

	glRasterPos3f(-1.8, -1.5, 0);
	char msg6[] = "SOLAR SYSTEM WILL BE VIEWED AFTER 10 SEC";
